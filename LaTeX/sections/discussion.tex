...
The $\hat{\beta}_2$ estimate of the Fixed Effects estimation model \eqref{eq:FE} in \tref{t:results} above \citep[identical to table 14.1 in][p. 464]{wooldridge2019introductory} indicates a large effect of \emph{grant lagged}. However, the estimated effect becomes insignificant in model (5) under heteroscedasticity- and cluster-robust inference (which by definition increases the size of the standard errors). That is, I cannot be 95\% certain that receiving a grant had a statistically significant effect on scrap rates in the same year or a lagged effect the next year. On the contrary, a p-value of 0.084 for $\hat{\beta}_1$ is decent considering the weak statistical power due to the low number of firms for which \emph{scrap} is recorded. Moreover, the large size of $\hat{\beta}_2$ and its p-value of 0.141 implies that I cannot rule out lagged effects either.
